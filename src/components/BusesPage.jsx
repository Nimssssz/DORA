...
import "./BusesPage.css";  // Create this CSS file based on HotelsPage.css
    ...
    <div className="container">
      ...
      <div className="search-box">
        {selectedOption === "Buses" && (
          <>
            <h2>Search Buses</h2>
            {/* Add detailed bus search functionality here */}
            <p>Find the best bus options for your travel.</p>
          </>
        )}
      </div>
    </div>
